    ...
    for idx in split_list:
        ...
        for line in list_fp:
            ...
            for obj in get(root, 'object'):
                ...
                occ = get_and_check(obj, 'occluded', 1).text
                ...
                ann = {'occluded': occ, 'area': o_width * o_height, 'iscrowd': 0, 'image_id':
...
if __name__ == '__main__':
    xml_list = '/media/wrc/0EB90E450EB90E45/data/car_only/train0.8/VOC2007/ImageSets/Main/'
    xml_dir = '/media/wrc/0EB90E450EB90E45/data/car_only/train0.8/VOC2007/Annotations'
    json_file = '/media/wrc/0EB90E450EB90E45/data/car_only/train0.8/coco/annotations/'
